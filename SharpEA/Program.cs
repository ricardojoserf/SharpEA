...
namespace SharpEA
{
    internal class Program
    {
        ...
        static void writeEA(String ea_filename, String ea_name_str, String ea_value_str)
        {
            ...
            int ea_content_arr_size = ea_name_str.Length + 1 + ea_value_str.Length; // + 1;
            ...
            // System.Buffer.BlockCopy(aux_bytearr, 0, ea_content_arr, ea_name_bytearr.Length + aux_bytearr.Length + ea_value_bytearr.Length, aux_bytearr.Length);
